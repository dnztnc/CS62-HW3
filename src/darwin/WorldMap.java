...
public class WorldMap {
	 ...
	 * 
	 * @param pos is a valid position 
	 * @param c is the character to be put into the square 
	 * @param dir is Position.NORTH,Position.SOUTH,Position.EAST,or Position.WEST (dir
	 * is ignored if c is ' ') 
	 * @param color is "black", "red", "gray", "dark gray", "pink", "orange", "yellow",
	 * "green", "magenta", "cyan", "blue" (color is ignored if c is ' ').
	 */
	 ...
	 *  @param millis is the number of milliseconds to pause
	 */
